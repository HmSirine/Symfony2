...
class RegisterType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        ->add('prenom', TextType::class, [
            'constraints' => [
                new NotBlank([
                    'message' => 'Le champ pr̩nom ne doit pas ̻tre vide.',
                ]),
                new Length([
                    'min' => 2,
                    'max' => 50,
                    'minMessage' => 'Le champ pr̩nom doit contenir au moins {{ limit }} caract̬res.',
                    'maxMessage' => 'Le champ pr̩nom doit contenir au maximum {{ limit }} caract̬res.',
                ]),
            ]
        ])
