...
// Utilisez la liste triée pour afficher les éléments dans votre table
    ...
    private void modifierReservation(ActionEvent event) {
        ...
        Reservation_Evenement r =  (Reservation_Evenement) table.getSelectionModel().getSelectedItem();
        
        r.setNom(NewNom.getText());
        r.setPrenom(NewPrenom.getText());
        r.setMail(NewMail.getText());
        r.setTel(NewTel.getText());
        r.setHeure_arriver(NewHeure_arrivee.getText());
    ...
    NewNom.setText(nom.getCellData(index).toString());
    NewMail.setText(mail.getCellData(index).toString());
    NewPrenom.setText(prenom.getCellData(index).toString());
    NewTel.setText(tel.getCellData(index).toString());
    NewHeure_arrivee.setText(heure_arrivee.getCellData(index).toString());
    }
}
