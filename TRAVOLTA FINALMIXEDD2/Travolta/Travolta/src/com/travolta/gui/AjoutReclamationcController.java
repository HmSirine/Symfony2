 ...
 * @author aghx0
 */
public class AjoutReclamationcController implements Initializable {
...
// Utilisez la liste triée pour afficher les éléments dans votre table
    ...
    private void AjoutReclamation(ActionEvent event) {
        ...
        try {
            ...
            message.setSubject("Ajout reclamation");
            message.setText("votre reclamation a été ajouté avec succees"
                    + " attender la reponse de ladmin"
                    + "envoyer par lequipe de travolta  .");
