 ...
 */
public class ReservationMaisonClientController implements Initializable {
...
//int id = Integer.parseInt(client1.getText());
    ...
    private void RetourMenu(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("InterfaceReservationMaisonClient.fxml"));
