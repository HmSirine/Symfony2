...
public class InterfaceClientController implements Initializable {
    ...
    @FXML
    private Button ghacentosirineclient;
    ...
    private void reservationmaison(ActionEvent event) throws IOException {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("ListeMaison.fxml"));
        Parent root = loader.load();
        Scene newScene = new Scene(root);
        Stage stage = (Stage) ReservationMaison.getScene().getWindow();
        stage.setScene(newScene);
        stage.show();
    }
    ...
    private void reservationhotel(ActionEvent event) throws IOException {
         FXMLLoader loader = new FXMLLoader(getClass().getResource("ListeHotel.fxml"));
        Parent root = loader.load();
        Scene newScene = new Scene(root);
        Stage stage = (Stage) reservationHotel.getScene().getWindow();
        stage.setScene(newScene);
        stage.show();
    }

    @FXML
    private void GhacenToSirineClient(ActionEvent event) throws IOException {
