...
public class InterfaceReservationController implements Initializable {
    ...
    private TableColumn<ReservationChambreHotel, LocalDate> date_arrivee;
    private TableColumn<ReservationChambreHotel, LocalDate> date_depart;
   // @FXML
   // private TableColumn<ReservationChambreHotel, Inte> chambre;
    //@FXML
    //private TableColumn<ReservationChambreHotel, ?> client;
    private TableColumn<ReservationChambreHotel, Float> tarif;
    @FXML
