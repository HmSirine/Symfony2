 ...
 */
public class ModifierResMaisonClientController implements Initializable {
...
// Utilisez la liste triée pour afficher les éléments dans votre table
    ...
    private void RetourMenu(ActionEvent event) throws IOException {
              FXMLLoader loader = new FXMLLoader(getClass().getResource("ReservationMaisonClient.fxml"));
